...
fileName        = "../models/bagging_" + labelName + ".bin"
file            = None
writeToFile     = False
try:
...
if file is not None:
    ...
    if rSquaredNew > rSquaredOld:
        print( "Old bagger with an R2 value of " + str(rSquaredOld) + " has been replaced with a new one (R2=" + str(rSquaredNew) + ")" )
        writeToFile = True
    else:
        print( "Old bagger prevails (R2=" + str(rSquaredOld) + ")" )
